...
GetDataCatches <- function(CArea=catchareas, Cspec=species,
Cstart=tstart, Cstop=tstop, Cmeshmin=min_mesh_size, Cmeshmax=max_mesh_size) {
...
#CREATE A TABLE WITH ALL SELECTED DATA 
TheData <- GetDataCatches(CArea=catchareas, Cspec=species,Cstart=tstart,
            Cstop=tstop, Cmeshmin=min_mesh_size, Cmeshmax=max_mesh_size)
